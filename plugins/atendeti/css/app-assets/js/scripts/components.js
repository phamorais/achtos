...
function widgetChatMessageDemo(source) {
  ...
  var id = $("#id").val();
  if (message != "") {
    gravaAcompanhamento(id,message);
    var html = '<div class="chat-message chat-left">' + "<p>" + message + "</p>" + "<div class=" + "chat-time" + ">5:01 PM</div></div>";
  ...
  function gravaAcompanhamento(ticket_id,message) {
    ...
    ({
        ...
        data: {"requisicao":"insert_followup","kanban_curr_item_id" : ticket_id,"message" : message,"privado":privado},
