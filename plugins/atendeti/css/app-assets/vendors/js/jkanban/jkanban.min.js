        ...
        ! function() {
            this.jKanban = function() {
                ...
                arguments[0] && "object" == typeof arguments[0] && (this.options = function(e, t) {
                    ...
                    }).on("drop", async function(e, t, n, r) {

                                if(await movendoKanban(e, t, n,b)){
                                    b.enableAllBoards();
                    ...
                    for (var i in e) {
                        var a = e[i];
                        t || b.options.boards.push(a), b.options.responsivePercentage || ("" === b.container.style.width ? b.container.style.width = (parseInt(n) +200) + 2 * parseInt(b.options.gutter) + "px" : b.container.style.width = parseInt(b.container.style.width) + parseInt(n) + 2 * parseInt(b.options.gutter) + "px");
